...
impl Network {
    ...
    pub fn from_magic(magic: u32) -> Option<Network> {
        ...
        match magic {
            0x8AAB76BA => Some(Network::Bitcoin),
...
mod tests {
    ...
    #[test]
    fn serialize_test() {
        assert_eq!(serialize(&Network::Bitcoin.magic()), &[0x4a, 0x82, 0x10, 0xd9]);
        assert_eq!(serialize(&Network::Testnet.magic()), &[0xba, 0x76, 0xab, 0x8a]);
